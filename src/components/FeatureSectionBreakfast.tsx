...
const data = [
    ...
    { id: 1, img: "product__2.webp", name: "Crunchy Crispa", price: "$300" },
    { id: 2, img: "product__3.webp", name: "Jewel Cranberries", price: "$200" },
    { id: 3, img: "product__4.webp", name: "Almond organic", price: "$100" },
];

const FeatureSectionBrekfast = () => {
    return (
        <div className=" container pt-16">
            <div className=" lg:flex justify-between items-center">
                <div>
                    <h3 className=" font-medium text-2xl">Breakfast & Dairy</h3>
                    <p className=" text-gray-600 mt-2">Bye Best quality Breakfast online form big-baskate shop near you.</p>
                </div>
...
export default FeatureSectionBrekfast
