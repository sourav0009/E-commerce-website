...
const FeatureSectionEruits = () => {
    return (
        <div className=" container pt-16">
            <div className=" lg:flex justify-between items-center">
                <div>
                    <h3 className=" font-medium text-2xl">Fruits & Vegetables</h3>
                    <p className=" text-gray-600 mt-2">Bye farm fresh Fruits and Vegetables online ai the best price</p>
                </div>
...
export default FeatureSectionEruits
